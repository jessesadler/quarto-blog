...
date: "2017-10-02"
description: "Why R, and specifically the tidyverse, is better than Excel for data analysis and visualization"
categories: ["rstats", "digitalhumanities"]
---
...
```{r}
#| label = "distinct sources and locations"
...
```{r}
#| label = "save sources and locations"
