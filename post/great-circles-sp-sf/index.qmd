...
date: "2018-03-28"
description: "Creating great circles in R with the sp and sf packages"
categories:
  - rstats
  - rspatial
---
...
![World Map by Gerardus Mercator, 1569](img/Mercator-1569.png){#fig-mercator}
...
```{r}
#| label: sources-destinations-matrices
...
-   Great circles with `sf` - [Martin Hadley -- Great circles with sf and leaflet](http://www.visibledata.co.uk/blog/2018/02/28/2018-02-28_great-circles-with-sf-and-leaflet/) - [Juan Mayorga -- Mapping the Global Network of Transnational Fisheries](http://jsmayorga.com/post/mapping-the-global-network-of-transnational-fisheries/)
